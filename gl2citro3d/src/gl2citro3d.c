...
#include "gl2citro3d_shader_shbin.h"
...
void gl2c3d_init(void) {
    ...
    /* Load embedded shader binary (compiled from gl2citro3d_shader.pica by picasso) */
    g.shader_dvlb = DVLB_ParseFile((u32*)gl2citro3d_shader_shbin,
                                    gl2citro3d_shader_shbin_size);
