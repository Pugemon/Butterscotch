...
RValue VMBuiltins_getVariable(VMContext *ctx, Variable* varDef, int32_t arrayIndex) {
    ...
    switch (varDef->builtinId) {
        ...
        // --- OS constants ---
        case B_OS_TYPE: return RValue_makeReal(4.0); // os_linux
        case B_OS_WINDOWS: return RValue_makeReal(0.0);
        case B_OS_PS4: return RValue_makeReal(6.0);
        case B_OS_PSVITA: return RValue_makeReal(12.0);
        case B_OS_3DS: return RValue_makeReal(14.0);
        case B_OS_SWITCH: return RValue_makeReal(19.0);

        // --- Instance properties ---
        case B_X: return inst ? RValue_makeReal(inst->x) : RValue_makeReal(0.0);
        case B_Y: return inst ? RValue_makeReal(inst->y) : RValue_makeReal(0.0);
        case B_XPREVIOUS: return inst ? RValue_makeReal(inst->xprevious) : RValue_makeReal(0.0);
        case B_YPREVIOUS: return inst ? RValue_makeReal(inst->yprevious) : RValue_makeReal(0.0);
        case B_XSTART: return inst ? RValue_makeReal(inst->xstart) : RValue_makeReal(0.0);
        case B_YSTART: return inst ? RValue_makeReal(inst->ystart) : RValue_makeReal(0.0);
        case B_VISIBLE: return inst ? RValue_makeBool(inst->visible) : RValue_makeBool(false);
        case B_DEPTH: return inst ? RValue_makeReal((GMLReal) inst->depth) : RValue_makeReal(0.0);
        case B_SPEED: return inst ? RValue_makeReal(inst->speed) : RValue_makeReal(0.0);
        case B_DIRECTION: return inst ? RValue_makeReal(inst->direction) : RValue_makeReal(0.0);
        case B_HSPEED: return inst ? RValue_makeReal(inst->hspeed) : RValue_makeReal(0.0);
        case B_VSPEED: return inst ? RValue_makeReal(inst->vspeed) : RValue_makeReal(0.0);
        case B_GRAVITY: return inst ? RValue_makeReal(inst->gravity) : RValue_makeReal(0.0);
        case B_GRAVITY_DIRECTION: return inst ? RValue_makeReal(inst->gravityDirection) : RValue_makeReal(0.0);
        case B_FRICTION: return inst ? RValue_makeReal(inst->friction) : RValue_makeReal(0.0);

        // --- Sprite/Image ---
        case B_IMAGE_SPEED: return inst ? RValue_makeReal(inst->imageSpeed) : RValue_makeReal(0.0);
        case B_IMAGE_INDEX: return inst ? RValue_makeReal(inst->imageIndex) : RValue_makeReal(0.0);
        case B_IMAGE_XSCALE: return inst ? RValue_makeReal(inst->imageXscale) : RValue_makeReal(0.0);
        case B_IMAGE_YSCALE: return inst ? RValue_makeReal(inst->imageYscale) : RValue_makeReal(0.0);
        case B_IMAGE_ANGLE: return inst ? RValue_makeReal(inst->imageAngle) : RValue_makeReal(0.0);
        case B_IMAGE_ALPHA: return inst ? RValue_makeReal(inst->imageAlpha) : RValue_makeReal(0.0);
        case B_IMAGE_BLEND: return inst ? RValue_makeReal((GMLReal) inst->imageBlend) : RValue_makeReal(0.0);
        case B_IMAGE_NUMBER:
            if (inst && inst->spriteIndex >= 0) {
                Sprite *sprite = &ctx->runner->dataWin->sprt.sprites[inst->spriteIndex];
                return RValue_makeReal((GMLReal) sprite->textureCount);
            }
            return RValue_makeReal(0.0);
        case B_SPRITE_INDEX: return inst ? RValue_makeReal((GMLReal) inst->spriteIndex) : RValue_makeReal(-1.0);

        case B_SPRITE_WIDTH:
            if (inst && runner && inst->spriteIndex >= 0 && runner->dataWin->sprt.count > (uint32_t)inst->spriteIndex)
                return RValue_makeReal((GMLReal) runner->dataWin->sprt.sprites[inst->spriteIndex].width * inst->imageXscale);
            return RValue_makeReal(0.0);

        case B_SPRITE_HEIGHT:
            if (inst && runner && inst->spriteIndex >= 0 && runner->dataWin->sprt.count > (uint32_t)inst->spriteIndex)
                return RValue_makeReal((GMLReal) runner->dataWin->sprt.sprites[inst->spriteIndex].height * inst->imageYscale);
            return RValue_makeReal(0.0);

        case B_MASK_INDEX: return inst ? RValue_makeReal((GMLReal) inst->maskIndex) : RValue_makeReal(-1.0);
        case B_ID: return inst ? RValue_makeReal((GMLReal) inst->instanceId) : RValue_makeReal(-1.0);
        case B_OBJECT_INDEX: return inst ? RValue_makeReal((GMLReal) inst->objectIndex) : RValue_makeReal(-1.0);

        case B_ALARM:
            if (inst && arrayIndex >= 0 && arrayIndex < GML_ALARM_COUNT) {
                return RValue_makeReal((GMLReal) inst->alarm[arrayIndex]);
            }
            return RValue_makeReal(-1.0);

            // --- Path properties ---
        case B_PATH_INDEX: return inst ? RValue_makeReal((GMLReal) inst->pathIndex) : RValue_makeReal(-1.0);
        case B_PATH_POSITION: return inst ? RValue_makeReal(inst->pathPosition) : RValue_makeReal(0.0);
        case B_PATH_POSITIONPREVIOUS: return inst ? RValue_makeReal(inst->pathPositionPrevious) : RValue_makeReal(0.0);
        case B_PATH_SPEED: return inst ? RValue_makeReal(inst->pathSpeed) : RValue_makeReal(0.0);
        case B_PATH_SCALE: return inst ? RValue_makeReal(inst->pathScale) : RValue_makeReal(1.0);
        case B_PATH_ORIENTATION: return inst ? RValue_makeReal(inst->pathOrientation) : RValue_makeReal(0.0);
        case B_PATH_ENDACTION: return inst ? RValue_makeReal((GMLReal) inst->pathEndAction) : RValue_makeReal(0.0);
        ...
        case B_BBOX_BOTTOM: {
            if (inst && runner) {
                ...
                if (bbox.valid) {
                    switch (varDef->builtinId) {
                        case B_BBOX_LEFT: return RValue_makeReal(bbox.left);
                        case B_BBOX_RIGHT: return RValue_makeReal(bbox.right);
                        case B_BBOX_TOP: return RValue_makeReal(bbox.top);
                        default: return RValue_makeReal(bbox.bottom);
                    }
                }
            }
            return RValue_makeReal(inst ? ((varDef->builtinId == B_BBOX_LEFT || varDef->builtinId == B_BBOX_RIGHT) ? inst->x : inst->y) : 0.0);
        }

        // --- Room / View ---
        case B_ROOM: return runner ? RValue_makeReal((GMLReal) runner->currentRoomIndex) : RValue_makeReal(0.0);
        case B_ROOM_SPEED: return runner ? RValue_makeReal((GMLReal) runner->currentRoom->speed) : RValue_makeReal(0.0);
        case B_ROOM_WIDTH: return runner ? RValue_makeReal((GMLReal) runner->currentRoom->width) : RValue_makeReal(0.0);
        case B_ROOM_HEIGHT: return runner ? RValue_makeReal((GMLReal) runner->currentRoom->height) : RValue_makeReal(0.0);
        case B_ROOM_PERSISTENT: return runner ? RValue_makeBool(runner->currentRoom->persistent) : RValue_makeBool(false);

        case B_VIEW_CURRENT: return runner ? RValue_makeReal((GMLReal) runner->viewCurrent) : RValue_makeReal(0.0);

        case B_VIEW_XVIEW: case B_VIEW_YVIEW: case B_VIEW_WVIEW: case B_VIEW_HVIEW:
        case B_VIEW_VISIBLE: case B_VIEW_HBORDER: case B_VIEW_VBORDER: case B_VIEW_OBJECT: {
            if (!runner || arrayIndex < 0 || arrayIndex >= MAX_VIEWS) {
                switch (varDef->builtinId) {
                    case B_VIEW_VISIBLE: return RValue_makeBool(false);
                    case B_VIEW_OBJECT: return RValue_makeReal(-4.0);
                    default: return RValue_makeReal(0.0);
                }
            }
            RoomView *v = &runner->currentRoom->views[arrayIndex];
            switch (varDef->builtinId) {
                case B_VIEW_XVIEW:   return RValue_makeReal((GMLReal) v->viewX);
                case B_VIEW_YVIEW:   return RValue_makeReal((GMLReal) v->viewY);
                case B_VIEW_WVIEW:   return RValue_makeReal((GMLReal) v->viewWidth);
                case B_VIEW_HVIEW:   return RValue_makeReal((GMLReal) v->viewHeight);
                case B_VIEW_VISIBLE: return RValue_makeBool(v->enabled);
                case B_VIEW_HBORDER: return RValue_makeReal((GMLReal) v->borderX);
                case B_VIEW_VBORDER: return RValue_makeReal((GMLReal) v->borderY);
                case B_VIEW_OBJECT:  return RValue_makeReal((GMLReal) v->objectId);
                default: break;
            }
            break;
        }
        case B_VIEW_ANGLE:
            if (!runner || arrayIndex < 0 || arrayIndex >= MAX_VIEWS) return RValue_makeReal(0.0);
            return RValue_makeReal(runner->viewAngles[arrayIndex]);

        // --- Backgrounds ---
        case B_BG_VISIBLE: case B_BG_INDEX: case B_BG_X: case B_BG_Y:
        case B_BG_HSPEED: case B_BG_VSPEED: case B_BG_WIDTH: case B_BG_HEIGHT: case B_BG_ALPHA: {
            if (!runner || arrayIndex < 0 || arrayIndex >= MAX_BACKGROUNDS) {
                switch (varDef->builtinId) {
                    case B_BG_VISIBLE: return RValue_makeBool(false);
                    case B_BG_INDEX: return RValue_makeReal(-1.0);
                    case B_BG_ALPHA: return RValue_makeReal(1.0);
                    default: return RValue_makeReal(0.0);
                }
            }
            RuntimeBackground *bg = &runner->backgrounds[arrayIndex];
            switch (varDef->builtinId) {
                case B_BG_VISIBLE: return RValue_makeBool(bg->visible);
                case B_BG_INDEX: return RValue_makeReal((GMLReal) bg->backgroundIndex);
                case B_BG_X: return RValue_makeReal(bg->x);
                case B_BG_Y: return RValue_makeReal(bg->y);
                case B_BG_HSPEED: return RValue_makeReal(bg->speedX);
                case B_BG_VSPEED: return RValue_makeReal(bg->speedY);
                case B_BG_WIDTH: {
                    int32_t tpagIndex = Renderer_resolveBackgroundTPAGIndex(runner->dataWin, bg->backgroundIndex);
                    return RValue_makeReal(tpagIndex >= 0 ? runner->dataWin->tpag.items[tpagIndex].boundingWidth : 0.0);
                }
                case B_BG_HEIGHT: {
                    int32_t tpagIndex = Renderer_resolveBackgroundTPAGIndex(runner->dataWin, bg->backgroundIndex);
                    return RValue_makeReal(tpagIndex >= 0 ? runner->dataWin->tpag.items[tpagIndex].boundingHeight : 0.0);
                }
                case B_BG_ALPHA: return RValue_makeReal(bg->alpha);
                default: break;
            }
            break;
        }
        case B_BG_COLOR: return runner ? RValue_makeReal((GMLReal) runner->backgroundColor) : RValue_makeReal(0.0);
        ...
        case B_FPS: return RValue_makeReal(ctx->dataWin->gen8.gms2FPS);

        // --- Arguments ---
        case B_ARGUMENT_COUNT: return RValue_makeReal((GMLReal) ctx->scriptArgCount);
        case B_ARGUMENT:
        ...
        case B_ARGUMENT0: case B_ARGUMENT1: case B_ARGUMENT2: case B_ARGUMENT3:
        case B_ARGUMENT4: case B_ARGUMENT5: case B_ARGUMENT6: case B_ARGUMENT7:
        case B_ARGUMENT8: case B_ARGUMENT9: case B_ARGUMENT10: case B_ARGUMENT11:
        case B_ARGUMENT12: case B_ARGUMENT13: case B_ARGUMENT14: case B_ARGUMENT15: {
            int argIndex = varDef->builtinId - B_ARGUMENT0;
            if (ctx->scriptArgs && argIndex < ctx->scriptArgCount) {
                RValue val = ctx->scriptArgs[argIndex];
                val.ownsString = false;
                return val;
            }
            return RValue_makeUndefined();
        ...
        case B_MOUSE_X: return RValue_makeReal((GMLReal) runner->keyboard->mouseX);
        case B_MOUSE_Y: return RValue_makeReal((GMLReal) runner->keyboard->mouseY);
#endif
        case B_KEYBOARD_KEY: return RValue_makeReal((GMLReal) runner->keyboard->lastKey);
        case B_APP_SURFACE: return RValue_makeReal(-1.0);

        // --- Constants ---
        case B_TRUE: return RValue_makeBool(true);
        case B_FALSE: return RValue_makeBool(false);
        case B_PI: return RValue_makeReal(3.14159265358979323846);
        case B_UNDEFINED: return RValue_makeUndefined();

        // --- Path action constants ---
        case B_PATH_ACTION_STOP: return RValue_makeReal(0.0);
        case B_PATH_ACTION_RESTART: return RValue_makeReal(1.0);
        case B_PATH_ACTION_CONTINUE: return RValue_makeReal(2.0);
        case B_PATH_ACTION_REVERSE: return RValue_makeReal(3.0);

    } // switch

    fprintf(stderr, "VM: Unhandled built-in variable read (builtinId=%d, arrayIndex=%d)\n", varDef->builtinId, arrayIndex);
    return RValue_makeReal(0.0);
}
    ...
    static RValue builtinIsReal([[maybe_unused]] VMContext *ctx, RValue *args, int32_t argCount) {
        if (1 > argCount) return RValue_makeBool(false);
        bool result = args[0].type == RVALUE_REAL || args[0].type == RVALUE_INT32 || args[0].type == RVALUE_INT64 ||
                      args[0]
                      .type == RVALUE_BOOL;
    ...
    static RValue builtinStringInsert([[maybe_unused]] VMContext *ctx, RValue *args, int32_t argCount) {
        if (3 > argCount || args[0].type != RVALUE_STRING || args[1].type != RVALUE_STRING)
            return
    ...
    static RValue builtinStringReplaceAll([[maybe_unused]] VMContext *ctx, RValue *args, int32_t argCount) {
        if (3 > argCount || args[0].type != RVALUE_STRING || args[1].type != RVALUE_STRING || args[2].type !=
            RVALUE_STRING)
    ...
    static RValue builtinRoomGotoNext(VMContext *ctx, [[maybe_unused]] RValue *args,
    ...
    static RValue builtinOsGetLanguage([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                       [[maybe_unused]] int32_t argCount) {
        return RValue_makeOwnedString(safeStrdup("en"));
    }

    static RValue builtinOsGetRegion([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                     [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinDsMapCreate([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                     [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinDsListCreate([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                      [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinDsListFindIndex([[maybe_unused]] VMContext *ctx, RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        int32_t id = RValue_toInt32(args[0]);
        DsList *list = dsListGet(id);
        ...
        for (int32_t i = 0; (int32_t) arrlen(list->items) > i; i++) {
            ...
            switch (item.type) {
                ...
                case RVALUE_INT64:
                    ...
                    break;
                case RVALUE_STRING:
                    if (item.string != nullptr && needle.string != nullptr && strcmp(item.string, needle.string) == 0)
    ...
    static RValue builtinArrayLengthId([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                       [[maybe_unused]] int32_t argCount) {
...
#define STUB_RETURN_UNDEFINED(name) \
    ...
    static RValue builtin_audioStopAll([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                       [[maybe_unused]] int32_t argCount) {
        AudioSystem *audio = getAudioSystem(ctx);
        if (audio == nullptr) return RValue_makeUndefined();
    ...
    static RValue builtin_audioStopMusic([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        AudioSystem *audio = getAudioSystem(ctx);
        if (audio == nullptr) return RValue_makeUndefined();
    ...
    static RValue builtin_audioMusicIsPlaying([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                              [[maybe_unused]] int32_t argCount) {
        AudioSystem *audio = getAudioSystem(ctx);
        if (audio == nullptr) return RValue_makeBool(false);
        if (lastMusicInstance >= 0) {
    ...
    static RValue builtin_audioPauseAll([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                        [[maybe_unused]] int32_t argCount) {
        AudioSystem *audio = getAudioSystem(ctx);
        if (audio == nullptr) return RValue_makeUndefined();
    ...
    static RValue builtin_audioResumeAll([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        AudioSystem *audio = getAudioSystem(ctx);
        if (audio == nullptr) return RValue_makeUndefined();
...
#define MAX_OPEN_TEXT_FILES 32
    ...
    static RValue builtinFileTextReadString([[maybe_unused]] VMContext *ctx, RValue *args, int32_t argCount) {
        if (1 > argCount) return RValue_makeOwnedString(safeStrdup(""));
        int32_t handle = RValue_toInt32(args[0]);
        if (0 > handle || handle >= MAX_OPEN_TEXT_FILES || !openTextFiles[handle].isOpen)
    ...
    static RValue builtinFileTextReadln([[maybe_unused]] VMContext *ctx, RValue *args, int32_t argCount) {
        if (1 > argCount) return RValue_makeOwnedString(safeStrdup(""));
        int32_t handle = RValue_toInt32(args[0]);
        if (0 > handle || MAX_OPEN_TEXT_FILES <= handle || !openTextFiles[handle].isOpen)
            return RValue_makeOwnedString(
                safeStrdup(""));
    ...
    static RValue builtinMouseCheckButton(VMContext *ctx, RValue *args, int32_t argc) {
        (void) ctx;
        if (argc < 1) return RValue_makeBool(false);
        Runner *runner = (Runner *) ctx->runner;
        int32_t btn = (int32_t) RValue_toReal(args[0]);
        return RValue_makeBool(RunnerKeyboard_mouseCheck(runner->keyboard, btn));
    }

    static RValue builtinMouseCheckButtonPressed(VMContext *ctx, RValue *args, int32_t argc) {
        (void) ctx;
        if (argc < 1) return RValue_makeBool(false);
        Runner *runner = (Runner *) ctx->runner;
        int32_t btn = (int32_t) RValue_toReal(args[0]);
        return RValue_makeBool(RunnerKeyboard_mouseCheckPressed(runner->keyboard, btn));
    }

    static RValue builtinMouseCheckButtonReleased(VMContext *ctx, RValue *args, int32_t argc) {
        (void) ctx;
        if (argc < 1) return RValue_makeBool(false);
        Runner *runner = (Runner *) ctx->runner;
        int32_t btn = (int32_t) RValue_toReal(args[0]);
        return RValue_makeBool(RunnerKeyboard_mouseCheckReleased(runner->keyboard, btn));
    }
    ...
    static RValue builtinWindowGetWidth(VMContext *ctx, [[maybe_unused]] RValue *args,
                                        [[maybe_unused]] int32_t argCount) {
        return RValue_makeReal((GMLReal) ctx->dataWin->gen8.defaultWindowWidth);
    }

    static RValue builtinWindowGetHeight(VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinInstanceActivateAll([[maybe_unused]] VMContext *ctx, [[maybe_unused]] RValue *args,
                                             [[maybe_unused]] int32_t argCount) {
        int instances = arrlen(ctx->runner->instances);
        repeat(instances, i) {
    ...
    static RValue builtinEventInherited(VMContext *ctx, [[maybe_unused]] RValue *args,
                                        [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        Instance *inst = (Instance *) ctx->currentInstance;
        if (inst == nullptr || 0 > ctx->currentEventObjectIndex || 0 > ctx->currentEventType) {
            fprintf(
                stderr, "VM: event_inherited called with no event context (inst=%p, eventObjIdx=%d, eventType=%d)\n",
        ...
        if (ctx->traceEventInherited) {
            fprintf(stderr, "VM: [%s] event_inherited owner=%s(%d) parent=%s(%d) event=%s (instanceId=%d)\n",
                    dataWin->objt.objects[inst->objectIndex].name, dataWin->objt.objects[ownerObjectIndex].name,
                    ownerObjectIndex, (0 > parentObjectIndex) ? "none" : dataWin->objt.objects[parentObjectIndex].name,
    ...
    static RValue builtinActionKillObject(VMContext *ctx, [[maybe_unused]] RValue *args,
                                          [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        if (ctx->currentInstance != nullptr) {
            Runner_destroyInstance(runner, (Instance *) ctx->currentInstance);
    ...
    static RValue builtinActionSetRelative(VMContext *ctx, [[maybe_unused]] RValue *args,
                                           [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinActionMoveTo(VMContext *ctx, [[maybe_unused]] RValue *args,
                                      [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinActionSetFriction(VMContext *ctx, [[maybe_unused]] RValue *args,
                                           [[maybe_unused]] int32_t argCount) {
        GMLReal val = RValue_toReal(args[0]);
    ...
    static RValue builtinActionSetGravity(VMContext *ctx, [[maybe_unused]] RValue *args,
                                          [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinActionSetHspeed(VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        GMLReal val = RValue_toReal(args[0]);
    ...
    static RValue builtinActionSetVspeed(VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        GMLReal val = RValue_toReal(args[0]);
    ...
    static RValue builtin_drawSpriteStretched(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        Renderer_drawSpriteStretched(runner->renderer, spriteIndex, subimg, x, y, w, h, 0xFFFFFF,
    ...
    static RValue builtin_drawSpritePartExt(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        Renderer_drawSpritePartExt(runner->renderer, spriteIndex, subimg, left, top, width, height, x, y, xscale,
                                   yscale,
                                   color, alpha);
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_drawRectangle(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        runner->renderer->vtable->drawRectangle(runner->renderer, x1, y1, x2, y2, runner->renderer->drawColor,
    ...
    static RValue builtin_drawBackground(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        runner->renderer->vtable->drawSprite(runner->renderer, tpagIndex, x, y, 0.0f, 0.0f, 1.0f, 1.0f, 0.0f, 0xFFFFFF,
                                             runner->renderer->drawAlpha);
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_drawBackgroundExt(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        runner->renderer->vtable->drawSprite(runner->renderer, tpagIndex, x, y, 0.0f, 0.0f, xscale, yscale, rot, color,
                                             alpha);
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_drawBackgroundStretched(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        runner->renderer->vtable->drawSprite(runner->renderer, tpagIndex, x, y, 0.0f, 0.0f, xscale, yscale, 0.0f,
                                             0xFFFFFF,
                                             runner->renderer->drawAlpha);
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_drawBackgroundPartExt(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        runner->renderer->vtable->drawSpritePart(runner->renderer, tpagIndex, left, top, width, height, x, y, xscale,
                                                 yscale, color, alpha);
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_draw_line(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        if (runner->renderer != nullptr) {
            ...
            float x2 = (float) RValue_toReal(args[2]);
            float y2 = (float) RValue_toReal(args[3]);
            runner->renderer->vtable->drawLine(runner->renderer, x1, y1, x2, y2, 1.0f, runner->renderer->drawColor,
                                               runner->renderer->drawAlpha);
        }
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_draw_line_width(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        if (runner->renderer != nullptr) {
            ...
            float y2 = (float) RValue_toReal(args[3]);
            float w = (float) RValue_toReal(args[4]);
            runner->renderer->vtable->drawLine(runner->renderer, x1, y1, x2, y2, w, runner->renderer->drawColor,
                                               runner->renderer->drawAlpha);
        }
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_draw_line_width_colour(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        if (runner->renderer != nullptr) {
            ...
            runner->renderer->vtable->drawLineColor(runner->renderer, x1, y1, x2, y2, w, col1, col2,
                                                    runner->renderer->drawAlpha);
        }
        return RValue_makeUndefined();
    }
    ...
    static RValue builtin_draw_get_colour(VMContext *ctx, [[maybe_unused]] RValue *args,
                                          [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        if (runner->renderer != nullptr) {
    ...
    static RValue builtin_draw_get_color(VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        if (runner->renderer != nullptr) {
            return RValue_makeReal((GMLReal) runner->renderer->drawColor);
    ...
    static RValue builtin_draw_get_alpha(VMContext *ctx, [[maybe_unused]] RValue *args,
                                         [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        if (runner->renderer != nullptr) {
    ...
    static RValue builtin_spriteCreateFromSurface(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        ...
        int32_t result = runner->renderer->vtable->createSpriteFromSurface(
            runner->renderer, x, y, w, h, removeback, smooth,
            xorig, yorig);
    ...
    static RValue builtin_spriteDelete(VMContext *ctx, RValue *args, [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        if (runner->renderer == nullptr || runner->renderer->vtable->deleteSprite == nullptr) return
    ...
    static RValue builtinMakeColorHsv([[maybe_unused]] VMContext *ctx, RValue *args, int32_t argCount) {
        ...
        if (360.0 > h && h >= 300.0) {
            ...
            g1 = 0;
            b1 = x;
        } else if (300.0 > h && h >= 240.0) {
            r1 = x;
            g1 = 0;
            b1 = c;
        } else if (240.0 > h && h >= 180.0) {
            r1 = 0;
            g1 = x;
            b1 = c;
        } else if (180.0 > h && h >= 120.0) {
            r1 = 0;
            g1 = c;
            b1 = x;
        } else if (120.0 > h && h >= 60.0) {
            r1 = x;
            g1 = c;
            b1 = 0;
        } else {
    ...
    static RValue builtinCollisionLine(VMContext *ctx, RValue *args, int32_t argCount) {
        ...
        repeat(count, i) {
            ...
            if (bbox.left > lineRight || lineLeft > bbox.right || bbox.top > lineBottom || lineTop > bbox.bottom)
                continue;
        ...
        repeat(count, i) {
            ...
            if (prec != 0) {
                ...
                if (spr != nullptr && spr->sepMasks == 1 && spr->masks != nullptr && spr->maskCount > 0) {
                    ...
                    for (int32_t py = startY; endY > py && !found; py++) {
                        for (int32_t px = startX; endX > px && !found; px++) {
                            if (Collision_pointInMask(ctx->dataWin, spr, inst, (GMLReal) px + 0.5,
                                                      (GMLReal) py + 0.5)) {
                                found = true;
                            }
                        }
    ...
    static RValue builtinActionSetAlarm(VMContext *ctx, [[maybe_unused]] RValue *args,
                                        [[maybe_unused]] int32_t argCount) {
    ...
    static RValue builtinTileLayerHide([[maybe_unused]] VMContext *ctx, RValue *args,
                                       [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
    ...
    static RValue builtinTileLayerShow([[maybe_unused]] VMContext *ctx, RValue *args,
                                       [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        int32_t depth = RValue_toInt32(args[0]);
        TileLayerState *layer = getOrCreateTileLayer(runner, depth);
    ...
    static RValue builtinTileLayerShift([[maybe_unused]] VMContext *ctx, RValue *args,
                                        [[maybe_unused]] int32_t argCount) {
        Runner *runner = (Runner *) ctx->runner;
        int32_t depth = RValue_toInt32(args[0]);
    ...
    void VMBuiltins_registerAll(void) {
        ...
        // Mouse
        registerBuiltin("mouse_check_button", builtinMouseCheckButton);
        registerBuiltin("mouse_check_button_pressed", builtinMouseCheckButtonPressed);
        registerBuiltin("mouse_check_button_released", builtinMouseCheckButtonReleased);
