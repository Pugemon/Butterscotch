...
static void captureScreenshot(SDLRenderer* sdlRenderer, const char* filenamePattern, int frameNumber, int width, int height) {
    ...
    SDL_SetRenderTarget(sdlRenderer->renderer, sdlRenderer->fboTexture);
    SDL_Rect rect = {0, 0, width, height};
    SDL_RenderReadPixels(sdlRenderer->renderer, &rect, SDL_PIXELFORMAT_ABGR8888, pixels, stride);
    SDL_SetRenderTarget(sdlRenderer->renderer, NULL);
